    ...
    <section className='flex items-center h-[calc(80vh-24px)]  justify-between'>
        <div className='basis-[50%] items-center  justify-center pl-[48px] flex-col'>
            ...
            <div className='flex space-x-8 py-8'>
                <Button name='Connect Wallet' className='bg-secondary text-white font-popins font-semibold px-8 py-3 rounded-[30px] text-[18px] leading-[42px] text-center' onClick={contractHook?.walletConnect} />
