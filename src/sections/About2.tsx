...
function About2() {
  return (
    <section className='grid min-h-[400px] lg:max-w-[1100px] my-6 mx-auto h-full grid-cols-2'>
        <div className='grid-cols-1 h-full justify-center flex flex-col'>
            ...
            <p className='text-[16px] leading-[24px] text-gray-200  py-5 text-left font-popins'>
           ...
           <p className='text-[16px] leading-[24px] text-gray-200  text-left font-popins'>Want to learn more about how vote processes are carried out? Kindly become a part of the community</p>
        </div>
